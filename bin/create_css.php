...
include __DIR__ . '/inc/recursive_copy.php';
...
include __DIR__ . '/inc/cssmin.php';

$conf = include __DIR__ . '/../../settings.conf.php';
...
recurse_copy( __DIR__ . '/../../../sass/', $temp_dir . '/sass/' );
